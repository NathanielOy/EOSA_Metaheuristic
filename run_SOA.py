...
for func_name in func_domain_ranges:
    ...
    done=['Brown', 'Bent Cigar', 'Composition1', 'Composition2', 'Dixon and Price', 'Discus Function', 
...
'Levy and Montalo', 'Noise', 'Pathological function', 'Perm','Powel', 'Quartic', 'Rastrigin',]
    if label in done:
        continue
    overall_best=0
