...
for func_name in func_domain_ranges:
    ...
    for run in range(number_of_runs):
        ...
        best, mean, std, worst, avg, median, deviation, gbest, time_system, total_time_train=pr.pr._save_results__(solutions=solutions, gbest=gbest, infec=[], recov=[], death=[], hosp=[], vaccin=[], suscep=[])
        overall_best+=best
        overall_mean+=mean
        overall_std+=std
        overall_worst+=worst
